...
- **Movie Catalog**: 14 open-source Blender Foundation movies hosted on Archive.org with poster images stored locally. Movies include Big Buck Bunny, Sintel, Tears of Steel, Elephants Dream, Spring, Cosmos Laundromat, Agent 327, Caminandes series (Llama Drama, Gran Dillama, Called to Arms), Coffee Run, Sprite Fright, Glass Half, and Hero.
